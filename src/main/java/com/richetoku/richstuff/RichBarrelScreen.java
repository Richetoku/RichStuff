...
public final class RichBarrelScreen extends AbstractContainerScreen<RichBarrelMenu> {
    public RichBarrelScreen(RichBarrelMenu menu,Inventory inventory,Component title){super(menu,inventory,title);imageWidth=RichBarrelMenu.WIDTH;imageHeight=RichBarrelMenu.HEIGHT;inventoryLabelX=8;inventoryLabelY=128;}
    @Override protected void renderBg(GuiGraphics g,float partialTick,int mouseX,int mouseY){
        ...
        slots(g,8,20,9,6);slots(g,8,140,9,3);slots(g,8,198,9,1);
    }
